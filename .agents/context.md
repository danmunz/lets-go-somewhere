...
- Browser-harness is connected for literal local visual review. It verified the roster, required briefing, first blind choice, contextual help return, and desktop/mobile map fallback. Commit `d25aca6` fixes a stale `#how-it-works` URL after the briefing/help return. The complete five-identity visual record and disposable-environment smoke are still required before production deployment.
