...
| [User journey map](ux.md) | Required screens, transitions, states, and participant/organizer experience. |
...
When a product change affects multiple documents, update them in the same change set. The product specification defines **what** the app must do; the journey map describes **how it should feel and flow**; the architecture describes **where the implementation belongs**.
